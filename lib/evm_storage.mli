...
val init : t -> Evm_stack.t -> Program_counter.t list -> Z3.Expr.expr list -> Z3.Expr.expr

val enc_equiv_at : t -> t -> Z3.Expr.expr -> Z3.Expr.expr -> Z3.Expr.expr

val enc_sload : t -> Evm_stack.t -> Z3.Expr.expr -> Z3.Expr.expr

val enc_sstore : t -> Evm_stack.t -> Z3.Expr.expr -> Z3.Expr.expr
